  ...
  return (
    <main className="relative z-10 max-w-7xl mx-auto px-6 pt-24 md:pt-40 pb-24 font-plusJakartaSans min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        {/* Contact Form */}
        <section className="p-8 md:p-12 rounded-[48px] bg-white/5 border border-white/10 shadow-3xl space-y-8">
            ...
            <div className="space-y-2 group">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-2xl py-4 pl-12 pr-6 text-sm text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all font-bold" 
                />
              </div>
            </div>
            <div className="space-y-2 group">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-6 text-sm text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all font-bold" 
                />
              </div>
            </div>
            <div className="space-y-2 group">
              ...
              <div className="relative">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-3xl py-4 pl-12 pr-6 text-sm text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all resize-none font-bold" 
                />
              </div>
            </div>
            <button 
              ...
              className={`w-full px-10 py-4 font-black uppercase text-xs tracking-[0.2em] rounded-2xl transition-all shadow-2xl flex items-center justify-center gap-3 group disabled:opacity-70 disabled:cursor-not-allowed ${
        ...
        <div className="space-y-16">
          <div className="space-y-8">
            <h3 className="text-xl font-black text-white uppercase tracking-widest border-l-4 border-blue-500 pl-6">Contact Channels</h3>
            
            <div className="space-y-10">
              <div className="group flex items-center gap-6">
                <div className="w-14 h-14 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/20 transition-all">
                  <Mail className="w-6 h-6 text-blue-400" />
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-1">Email Address</p>
                  <a href="mailto:harshmanmode79@gmail.com" className="text-lg font-black text-white hover:text-blue-400 transition-colors font-cinzel">harshmanmode79@gmail.com</a>
                </div>
              </div>
              ...
              <div className="group flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-black text-white font-cinzel">+91 83057-21431</p>
                </div>
              </div>
              ...
              <div className="group flex items-center gap-6">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-1">Current Location</p>
                  <p className="text-lg font-black text-white font-cinzel uppercase tracking-widest">Gwalior, INDIA</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Connect Digitally</h3>
            <div className="flex gap-4">
              <a href="https://github.com/Harsh-2006-git" target="_blank" className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center bg-white/5 transition-all group hover:bg-white hover:scale-110">
                <Github className="w-5 h-5 text-white group-hover:text-black transition-colors" />
              </a>
              <a href="https://linkedin.com/in/harsh-manmode-2a0b91325" target="_blank" className="w-12 h-12 rounded-full border border-blue-500/20 flex items-center justify-center bg-blue-500/5 transition-all group hover:bg-[#0077b5] hover:scale-110">
      ...
      <section className="space-y-12 max-w-7xl mx-auto pt-24 mb-12">
